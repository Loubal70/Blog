<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <form action="{{ route('posts.update', $post) }}" method="post" enctype="multipart/form-data" class="w-full my-10">
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full px-3 mb-6 md:mb-0">
                    ...
                    <textarea 
                        ...
                        name="content" 
                        rows="10" 
                        class="bg-gray-200 transition-colors appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white" >{{ $post->content }}</textarea>
                </div>
            </div>

            <div class="flex justify-end">
                <x-button>Modifier mon post</x-button>
            </div>
