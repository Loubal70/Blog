...
<footer class="fixed inset-x-0 bottom-0 px-6 py-2 text-gray-100 bg-gray-800">
    <div class="container flex flex-col items-center justify-between mx-auto md:flex-row"><a href="#"
            class="text-2xl font-bold">Louis B</a>
        <p class="mt-2 md:mt-0">Tous droits réservés {{ date('Y') }}.</p>
